...
int initRegSet()
{
  ...
  strcpy(regList[0].name, "$0");
  strcpy(regList[1].name, "$1");
  strcpy(regList[2].name, "$2");
  strcpy(regList[3].name, "$3");
  strcpy(regList[4].name, "$4");
  strcpy(regList[5].name, "$5");
  strcpy(regList[6].name, "$6");
  strcpy(regList[7].name, "$7");
  strcpy(regList[8].name, "$8");
  strcpy(regList[9].name, "$9");
  strcpy(regList[10].name, "$10");
  strcpy(regList[11].name, "$11");
  strcpy(regList[12].name, "$12");
  strcpy(regList[13].name, "$13");
  strcpy(regList[14].name, "$14");
  strcpy(regList[15].name, "$15");
  strcpy(regList[16].name, "$16");
  strcpy(regList[17].name, "$17");
  strcpy(regList[18].name, "$18");
  strcpy(regList[19].name, "$19");
  strcpy(regList[20].name, "$20");
  strcpy(regList[21].name, "$21");
  strcpy(regList[22].name, "$22");
  strcpy(regList[23].name, "$23");
  strcpy(regList[24].name, "$24");
  strcpy(regList[25].name, "$25");
  strcpy(regList[26].name, "$26");
  strcpy(regList[27].name, "$27");
  strcpy(regList[28].name, "$28");
  strcpy(regList[29].name, "$29");
  strcpy(regList[30].name, "$30");
  strcpy(regList[31].name, "$31");

  strcpy(regList[34].name, "$f0");
  strcpy(regList[35].name, "$f1");
  strcpy(regList[36].name, "$f2");
  strcpy(regList[37].name, "$f3");
  strcpy(regList[38].name, "$f4");
  strcpy(regList[39].name, "$f5");
  strcpy(regList[40].name, "$f6");
  strcpy(regList[41].name, "$f7");
  strcpy(regList[42].name, "$f8");
  strcpy(regList[43].name, "$f9");
  strcpy(regList[44].name, "$f10");
  strcpy(regList[45].name, "$f11");
  strcpy(regList[46].name, "$f12");
  strcpy(regList[47].name, "$f13");
  strcpy(regList[48].name, "$f14");
  strcpy(regList[49].name, "$f15");
  strcpy(regList[50].name, "$f16");
  strcpy(regList[51].name, "$f17");
  strcpy(regList[52].name, "$f18");
  strcpy(regList[53].name, "$f19");
  strcpy(regList[54].name, "$f20");
  strcpy(regList[55].name, "$f21");
  strcpy(regList[56].name, "$f22");
  strcpy(regList[57].name, "$f23");
  strcpy(regList[58].name, "$f24");
  strcpy(regList[59].name, "$f25");
  strcpy(regList[60].name, "$f26");
  strcpy(regList[61].name, "$f27");
  strcpy(regList[62].name, "$f28");
  strcpy(regList[63].name, "$f29");
  strcpy(regList[64].name, "$f30");
  strcpy(regList[65].name, "$f31");
