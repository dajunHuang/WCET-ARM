 ...
 *
 * $Id: misc.h,v 1.1.1.1 2000/11/29 14:53:54 cu-cs Exp $
 *
 * $Log: misc.h,v $
 ...
 *
 *
 * Revision 1.1.1.1.2.1  2000/09/05 13:56:01  taustin
...
void fatal_hook(void (*hook_fn)(FILE *stream)); /* fatal hook function */
...
void _fatal(const char *file, const char *func, int line, char *fmt, ...)
...
void _panic(const char *file, const char *func, int line, char *fmt, ...)
    __attribute__((noreturn));
#else  /* !__GNUC__ */
void panic(char *fmt, ...);
#endif /* !__GNUC__ */
...
void _info(char *file, char *func, int line, char *fmt, ...);
#else  /* !__GNUC__ */
void info(char *fmt, ...);
#endif /* !__GNUC__ */
...
void _debug(char *file, char *func, int line, char *fmt, ...);
#else  /* !__GNUC__ */
void debug(char *fmt, ...);
#endif /* !__GNUC__ */
