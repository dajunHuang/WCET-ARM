 ...
 *
 * $Id: stats.h,v 1.1.1.1 2000/11/29 14:53:54 cu-cs Exp $
 *
 * $Log: stats.h,v $
 ...
 *
 *
 * Revision 1.1.1.1.2.1  2000/10/13 17:44:44  chriswea
 * added stuff for ptrace
 *
 * Revision 1.2  2000/09/08 22:55:06  chriswea
 * for some reason these files were not updated before ???
 *
...
/* user-defined print function, if this option is selected, a function of this
   ...
   order */
typedef void (*print_fn_t)(struct stat_stat_t *stat, /* the stat variable being printed */
