...
void update_power_stats()
{
  ...
  if (bpred_access)
  {
    double tmp_bpred_power_cc = (double)btb_decaddr_hd * power.hd_btb_decoder_1ststg + ((btb_mem_cmd == Read) ? power.hd_btb_bitline_rd : power.hd_btb_bitline_wr) + (double)btaddr_hd * power.hd_btb_senseamp + (double)btb_decaddr_hd * power.hd_btb_tag_decoder_1ststg + ((btb_mem_cmd == Read) ? power.hd_btb_tag_bitline_rd : power.hd_btb_tag_bitline_wr) + (double)btb_tagaddr_hd * power.hd_btb_tag_senseamp + power.hd_btb + power.bpred_power - power.btb;
    if (bpred_access <= 2)
    {
  ...
  if (icache_access)
  {
    ...
    double tmp_icache_power_cc = (double)icache_decaddr_hd * power.hd_icache_decoder_1ststg + ((icache_mem_cmd == Read) ? power.hd_icache_bitline_rd : power.hd_icache_bitline_wr) + (double)icache_inst_hd * power.hd_icache_senseamp + (double)icache_decaddr_hd * power.hd_icache_tag_decoder_1ststg + ((icache_mem_cmd == Read) ? power.hd_icache_tag_bitline_rd : power.hd_icache_tag_bitline_wr) + (double)icache_tagaddr_hd * power.hd_icache_tag_senseamp + power.hd_icache_power + power.itlb;
  ...
  if (icache2_access)
  {
    ...
    double tmp_icache2_power_cc = (double)icache2_decaddr_hd * power.hd_icache2_decoder_1ststg + ((icache2_mem_cmd == Read) ? power.hd_icache2_bitline_rd : power.hd_icache2_bitline_wr) + (double)icache2_inst_hd * power.hd_icache2_senseamp + (double)icache2_decaddr_hd * power.hd_icache2_tag_decoder_1ststg + ((icache2_mem_cmd == Read) ? power.hd_icache2_tag_bitline_rd : power.hd_icache2_tag_bitline_wr) + (double)icache2_tagaddr_hd * power.hd_icache2_tag_senseamp + power.hd_icache2_power + power.itlb;
  ...
  if (dcache_access)
  {
    double tmp_dcache_power_cc = (double)dcache_decaddr_hd * power.hd_dcache_decoder_1ststg + ((dcache_mem_cmd == Read) ? power.hd_dcache_bitline_rd : power.hd_dcache_bitline_wr) + (double)dcache_data_hd * power.hd_dcache_senseamp + (double)dcache_decaddr_hd * power.hd_dcache_tag_decoder_1ststg + ((dcache_mem_cmd == Read) ? power.hd_dcache_tag_bitline_rd : power.hd_dcache_tag_bitline_wr) + (double)dcache_tagaddr_hd * power.hd_dcache_tag_senseamp + power.hd_dcache_power + power.dtlb;
  ...
  if (dcache2_access)
  {
    double tmp_dcache2_power_cc = (double)dcache2_decaddr_hd * power.hd_dcache2_decoder_1ststg + ((dcache2_mem_cmd == Read) ? power.hd_dcache2_bitline_rd : power.hd_dcache2_bitline_wr) + (double)dcache2_data_hd * power.hd_dcache2_senseamp + (double)dcache2_decaddr_hd * power.hd_dcache2_tag_decoder_1ststg + ((dcache2_mem_cmd == Read) ? power.hd_dcache2_tag_bitline_rd : power.hd_dcache2_tag_bitline_wr) + (double)dcache2_tagaddr_hd * power.hd_dcache2_tag_senseamp + power.hd_dcache2_power + power.dtlb;
  ...
  total_cycle_power = rename_power + bpred_power + window_power + lsq_power + regfile_power + icache_power + icache2_power + dcache_power + dcache2_power + alu_power + resultbus_power;

  total_cycle_power_cc1 = rename_power_cc1 + bpred_power_cc1 + window_power_cc1 + lsq_power_cc1 + regfile_power_cc1 + icache_power_cc1 + icache2_power_cc1 + dcache_power_cc1 + dcache2_power_cc1 + alu_power_cc1 + resultbus_power_cc1;

  hd_total_cycle_power_cc1 = rename_power_cc1 + hd_bpred_power_cc1 + window_power_cc1 + lsq_power_cc1 + regfile_power_cc1 + hd_icache_power_cc1 + hd_icache2_power_cc1 + hd_dcache_power_cc1 + hd_dcache2_power_cc1 + alu_power_cc1 + resultbus_power_cc1;

  total_cycle_power_cc2 = rename_power_cc2 + bpred_power_cc2 + window_power_cc2 + lsq_power_cc2 + regfile_power_cc2 + icache_power_cc2 + icache2_power_cc2 + dcache_power_cc2 + dcache2_power_cc2 + alu_power_cc2 + resultbus_power_cc2;

  hd_total_cycle_power_cc2 = rename_power_cc2 + hd_bpred_power_cc2 + window_power_cc2 + lsq_power_cc2 + regfile_power_cc2 + hd_icache_power_cc2 + hd_icache2_power_cc2 + hd_dcache_power_cc2 + hd_dcache2_power_cc2 + alu_power_cc2 + resultbus_power_cc2;

  total_cycle_power_cc3 = rename_power_cc3 + bpred_power_cc3 + window_power_cc3 + lsq_power_cc3 + regfile_power_cc3 + icache_power_cc3 + icache2_power_cc3 + dcache_power_cc3 + dcache2_power_cc3 + alu_power_cc3 + resultbus_power_cc3;

  hd_total_cycle_power_cc3 = rename_power_cc3 + hd_bpred_power_cc3 + window_power_cc3 + lsq_power_cc3 + regfile_power_cc3 + hd_icache_power_cc3 + hd_icache2_power_cc3 + hd_dcache_power_cc3 + hd_dcache2_power_cc3 + alu_power_cc3 + resultbus_power_cc3;
...
int cache;
{
  ...
  */
  ...
  Ceq = (3.0 * draincap(Wdec3to8p, PCH, 1) + draincap(Wdec3to8n, NCH, 3) +
         gatecap(WdecNORn + WdecNORp, ((numstack * 40) + 20.0))) *
        rowsb;
    ...
    power_result_type *power;
{
  ...
  */
  ...
  power->hd_btb_decoder_1ststg = ndwl * ndbl * array_decoder_power_1ststg(rowsb, colsb, predeclength, 1, 1, cache);
  power->hd_btb_tag_decoder_1ststg = 0.0;
  /*
  power->hd_btb_tag_decoder_1ststg
    = ntwl*ntbl*array_decoder_power_1ststg(trowsb,tcolsb,predeclength,1,1,cache);
  */
  power->hd_btb_decoder_2ndstg = ndwl * ndbl * array_decoder_power_2ndstg(rowsb, colsb, predeclength, 1, 1, cache);
  power->hd_btb_tag_decoder_2ndstg = 0.0;
  /*
  power->hd_btb_tag_decoder_2ndstg
    = ntwl*ntbl*array_decoder_power_2ndstg(trowsb,tcolsb,predeclength,1,1,cache);
  */
  power->hd_btb_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, dwordlinelength, 1, 1, cache);
  power->hd_btb_tag_wordline = 0.0;
  /*
  power->hd_btb_tag_wordline
    = ntwl*ntbl*array_wordline_power(trowsb,tcolsb,twordlinelength,1,1,cache);
  */
  power->hd_btb_bitline_rd = ndwl * ndbl * array_bitline_power_rd(rowsb, colsb, bitlinelength, 1, 1, cache);
  power->hd_btb_tag_bitline_rd = 0.0;
  /*
  power->hd_btb_tag_bitline_rd
    = ntwl*ntbl*array_bitline_power_rd(trowsb,tcolsb,bitlinelength,1,1,cache);
  */
  power->hd_btb_bitline_wr = ndwl * ndbl * array_bitline_power_wr(rowsb, colsb, bitlinelength, 1, 1, cache);
  power->hd_btb_tag_bitline_wr = 0.0;
  /*
  power->hd_btb_tag_bitline_wr
    = ntwl*ntbl*array_bitline_power_wr(trowsb,tcolsb,bitlinelength,1,1,cache);
  */
  power->hd_btb_senseamp = ndwl * ndbl * senseamp_power(colsb) / inst_width;
  power->hd_btb_tag_senseamp = 0.0;
  /*
  power->hd_btb_tag_senseamp
    = ntwl*ntbl*senseamp_power(tcolsb)/(double)tagsize;
  */

  power->hd_btb_tagarray = power->hd_btb_tag_decoder_2ndstg + power->hd_btb_tag_wordline;

  power->hd_btb = power->hd_btb_decoder_2ndstg + power->hd_btb_wordline + power->hd_btb_tagarray;
  ...
  else
  {
    ...
    predeclength = rowsb * (RegCellHeight + WordlineSpacing);
    dwordlinelength = colsb * (RegCellWidth + BitlineSpacing);
    twordlinelength = tcolsb * (RegCellWidth + BitlineSpacing);
    bitlinelength = rowsb * (RegCellHeight + WordlineSpacing);
    ...
    power->hd_icache_decoder_1ststg = ndwl * ndbl * array_decoder_power_1ststg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_icache_tag_decoder_1ststg = ntwl * ntbl * array_decoder_power_1ststg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_icache_decoder_2ndstg = ndwl * ndbl * array_decoder_power_2ndstg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_icache_tag_decoder_2ndstg = ntwl * ntbl * array_decoder_power_2ndstg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_icache_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, dwordlinelength, 1, 1, cache);
    power->hd_icache_tag_wordline = ntwl * ntbl * array_wordline_power(trowsb, tcolsb, twordlinelength, 1, 1, cache);
    power->hd_icache_bitline_rd = ndwl * ndbl * array_bitline_power_rd(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_icache_tag_bitline_rd = ntwl * ntbl * array_bitline_power_rd(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_icache_bitline_wr = ndwl * ndbl * array_bitline_power_wr(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_icache_tag_bitline_wr = ntwl * ntbl * array_bitline_power_wr(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_icache_senseamp = ndwl * ndbl * senseamp_power(colsb) / inst_width;
    power->hd_icache_tag_senseamp = ntwl * ntbl * senseamp_power(tcolsb) / (double)tagsize;

    power->hd_icache_tagarray = power->hd_icache_tag_decoder_2ndstg + power->hd_icache_tag_wordline;

    power->hd_icache_power = power->hd_icache_decoder_2ndstg + power->hd_icache_wordline + power->hd_icache_tagarray;
  }
  ...
  else
  {
    ...
    if (verbose)
    {
      ...
      power->icache2_decoder = ndwl * ndbl * array_decoder_power(rowsb, colsb, predeclength, 1, 1, cache);
      power->icache2_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, wordlinelength, 1, 1, cache);
      power->icache2_bitline = ndwl * ndbl * array_bitline_power(rowsb, colsb, bitlinelength, 1, 1, cache);
      power->icache2_senseamp = ndwl * ndbl * senseamp_power(colsb);
      power->icache2_tagarray = ntwl * ntbl * (simple_array_power(trowsb, tcolsb, 1, 1, cache));

      power->icache2_power = power->icache2_decoder + power->icache2_wordline + power->icache2_bitline + power->icache2_senseamp + power->icache2_tagarray;

      power->hd_icache2_decoder_1ststg = ndwl * ndbl * array_decoder_power_1ststg(rowsb, colsb, predeclength, 1, 1, cache);
      power->hd_icache2_tag_decoder_1ststg = ntwl * ntbl * array_decoder_power_1ststg(trowsb, tcolsb, predeclength, 1, 1, cache);
      power->hd_icache2_decoder_2ndstg = ndwl * ndbl * array_decoder_power_2ndstg(rowsb, colsb, predeclength, 1, 1, cache);
      power->hd_icache2_tag_decoder_2ndstg = ntwl * ntbl * array_decoder_power_2ndstg(trowsb, tcolsb, predeclength, 1, 1, cache);
      power->hd_icache2_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, dwordlinelength, 1, 1, cache);
      power->hd_icache2_tag_wordline = ntwl * ntbl * array_wordline_power(trowsb, tcolsb, twordlinelength, 1, 1, cache);
      power->hd_icache2_bitline_rd = ndwl * ndbl * array_bitline_power_rd(rowsb, colsb, bitlinelength, 1, 1, cache);
      power->hd_icache2_tag_bitline_rd = ntwl * ntbl * array_bitline_power_rd(trowsb, tcolsb, bitlinelength, 1, 1, cache);
      power->hd_icache2_bitline_wr = ndwl * ndbl * array_bitline_power_wr(rowsb, colsb, bitlinelength, 1, 1, cache);
      power->hd_icache2_tag_bitline_wr = ntwl * ntbl * array_bitline_power_wr(trowsb, tcolsb, bitlinelength, 1, 1, cache);
      power->hd_icache2_senseamp = ndwl * ndbl * senseamp_power(colsb) / inst_width;
      power->hd_icache2_tag_senseamp = ntwl * ntbl * senseamp_power(tcolsb) / (double)tagsize;

      power->hd_icache2_tagarray = power->hd_icache2_tag_decoder_2ndstg + power->hd_icache2_tag_wordline;

      power->hd_icache2_power = power->hd_icache2_decoder_2ndstg + power->hd_icache2_wordline + power->hd_icache2_tagarray;
    }
  ...
  else
  {
    ...
    power->hd_dcache_decoder_1ststg = ndwl * ndbl * array_decoder_power_1ststg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_dcache_tag_decoder_1ststg = ntwl * ntbl * array_decoder_power_1ststg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_dcache_decoder_2ndstg = ndwl * ndbl * array_decoder_power_2ndstg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_dcache_tag_decoder_2ndstg = ntwl * ntbl * array_decoder_power_2ndstg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_dcache_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, dwordlinelength, 1, 1, cache);
    power->hd_dcache_tag_wordline = ntwl * ntbl * array_wordline_power(trowsb, tcolsb, twordlinelength, 1, 1, cache);
    power->hd_dcache_bitline_rd = ndwl * ndbl * array_bitline_power_rd(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_dcache_tag_bitline_rd = ntwl * ntbl * array_bitline_power_rd(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_dcache_bitline_wr = ndwl * ndbl * array_bitline_power_wr(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_dcache_tag_bitline_wr = ntwl * ntbl * array_bitline_power_wr(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_dcache_senseamp = ndwl * ndbl * senseamp_power(colsb) / data_width;
    power->hd_dcache_tag_senseamp = ntwl * ntbl * senseamp_power(tcolsb) / (double)tagsize;

    /* Total consumed power by dcache */
    power->hd_dcache_tagarray = power->hd_dcache_tag_decoder_2ndstg + power->hd_dcache_tag_wordline;

    power->hd_dcache_power = power->hd_dcache_decoder_2ndstg + power->hd_dcache_wordline + power->hd_dcache_tagarray;
  }
  ...
  else
  {
    ...
    power->dcache2_decoder = res_memport * ndwl * ndbl * array_decoder_power(rowsb, colsb, predeclength, 1, 1, cache);
    power->dcache2_wordline = res_memport * ndwl * ndbl * array_wordline_power(rowsb, colsb, wordlinelength, 1, 1, cache);
    power->dcache2_bitline = res_memport * ndwl * ndbl * array_bitline_power(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->dcache2_senseamp = res_memport * ndwl * ndbl * senseamp_power(colsb);
    power->dcache2_tagarray = res_memport * ntwl * ntbl * (simple_array_power(trowsb, tcolsb, 1, 1, cache));
    ...
    power->hd_dcache2_decoder_1ststg = ndwl * ndbl * array_decoder_power_1ststg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_dcache2_tag_decoder_1ststg = ntwl * ntbl * array_decoder_power_1ststg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_dcache2_decoder_2ndstg = ndwl * ndbl * array_decoder_power_2ndstg(rowsb, colsb, predeclength, 1, 1, cache);
    power->hd_dcache2_tag_decoder_2ndstg = ntwl * ntbl * array_decoder_power_2ndstg(trowsb, tcolsb, predeclength, 1, 1, cache);
    power->hd_dcache2_wordline = ndwl * ndbl * array_wordline_power(rowsb, colsb, dwordlinelength, 1, 1, cache);
    power->hd_dcache2_tag_wordline = ntwl * ntbl * array_wordline_power(trowsb, tcolsb, twordlinelength, 1, 1, cache);
    power->hd_dcache2_bitline_rd = ndwl * ndbl * array_bitline_power_rd(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_dcache2_tag_bitline_rd = ntwl * ntbl * array_bitline_power_rd(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_dcache2_bitline_wr = ndwl * ndbl * array_bitline_power_wr(rowsb, colsb, bitlinelength, 1, 1, cache);
    power->hd_dcache2_tag_bitline_wr = ntwl * ntbl * array_bitline_power_wr(trowsb, tcolsb, bitlinelength, 1, 1, cache);
    power->hd_dcache2_senseamp = ndwl * ndbl * senseamp_power(colsb) / data_width;
    power->hd_dcache2_tag_senseamp = ntwl * ntbl * senseamp_power(tcolsb) / (double)tagsize;

    /* Total consumed power by dcache2 */
    power->hd_dcache2_tagarray = power->hd_dcache2_tag_decoder_2ndstg + power->hd_dcache2_tag_wordline;

    power->hd_dcache2_power = power->hd_dcache2_decoder_2ndstg + power->hd_dcache2_wordline + power->hd_dcache2_tagarray;
  }
  ...
  power->total_power = power->local_predict + power->global_predict + power->chooser + power->btb + power->rat_decoder + power->rat_wordline + power->rat_bitline + power->rat_senseamp + power->dcl_compare + power->dcl_pencode + power->inst_decoder_power + power->wakeup_tagdrive + power->wakeup_tagmatch + power->selection + power->regfile_decoder + power->regfile_wordline + power->regfile_bitline + power->regfile_senseamp + power->rs_decoder + power->rs_wordline + power->rs_bitline + power->rs_senseamp + power->lsq_wakeup_tagdrive + power->lsq_wakeup_tagmatch + power->lsq_rs_decoder + power->lsq_rs_wordline + power->lsq_rs_bitline + power->lsq_rs_senseamp + power->resultbus + power->clock_power + power->icache_power + power->icache2_power + power->itlb + power->dcache_power + power->dtlb + power->dcache2_power;

  power->total_power_nodcache2 = power->local_predict + power->global_predict + power->chooser + power->btb + power->rat_decoder + power->rat_wordline + power->rat_bitline + power->rat_senseamp + power->dcl_compare + power->dcl_pencode + power->inst_decoder_power + power->wakeup_tagdrive + power->wakeup_tagmatch + power->selection + power->regfile_decoder + power->regfile_wordline + power->regfile_bitline + power->regfile_senseamp + power->rs_decoder + power->rs_wordline + power->rs_bitline + power->rs_senseamp + power->lsq_wakeup_tagdrive + power->lsq_wakeup_tagmatch + power->lsq_rs_decoder + power->lsq_rs_wordline + power->lsq_rs_bitline + power->lsq_rs_senseamp + power->resultbus + power->clock_power + power->icache_power + power->itlb + power->dcache_power + power->dtlb;

  power->bpred_power = power->btb + power->local_predict + power->global_predict + power->chooser + power->ras;

  power->hd_bpred_power = power->hd_btb + power->local_predict + power->global_predict + power->chooser + power->ras;
