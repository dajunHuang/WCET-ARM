 ...
 *
 * $Id: sim-eio.c,v 1.1.1.1 2000/11/29 14:53:54 cu-cs Exp $
 *
 * $Log: sim-eio.c,v $
...
static enum { no_chkpt,
              one_shot_chkpt,
              periodic_chkpt } chkpt_kind = no_chkpt;
...
#include "machine.def"
  ...
  while (TRUE)
  {
    ...
    if (chkpt_kind == one_shot_chkpt && !range_cmp_range1(&chkpt_range, regs.regs_NPC,
    ...
    else if (chkpt_kind == periodic_chkpt && sim_num_insn == next_chkpt_cycle)
    {
